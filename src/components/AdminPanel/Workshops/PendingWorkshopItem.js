...
class PendingWorkshopItem extends Component {
  onDeleteClick = id => {
    ...
    return (
      <tr>
        ...
        <td style={{ width: "10%" }}>
          <button
            type="button"
            className="table-link btn btn-link p-0 mr-1"
            onClick={() => this.onAcceptWorkshopClick(workshop.id)}
